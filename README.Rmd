...
*Note: This README walks through package rational and contains the details of functions and first cut testing. [TLDR - Jump to traditional readme content](#traditional-readme)*
...
Other possible directions would be to just calculate x and y based on date in month and combine with faceting by month --  but also to position (x and y) based on month.  Furthermore, a dedicated Coord could be created (Teun's thought).  Then maybe dates would just feed generically in as the 'x' aes - this sounds cool!
